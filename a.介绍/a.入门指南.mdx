...
我们准备了一个在线开发调试环境，帮助您快速上手体验。**在线开发环境仅做体验使用， 数据每小时重置** 实际开发中，请在本地安装 Yao 开发调试，具体参考 [安装调试](/a.介绍/b.安装调试.mdx) 章节的文档。如果您的应用开发完成，需要在生产环境部署，请参考 [部署](/e.部署.mdx) 章节文档。
...
在项目 `models` 目录下，创建数据模型描述文件 `customer.mod.json`
