...
<blockquote>
	Yao 是一款 <strong>Go</strong> 语言驱动的低代码应用引擎，通过编写 JSON 描述即可快速制作{' '}
	<strong>API 接口</strong>，<strong>数据管理系统</strong> ，<strong>命令行工具</strong>
	等应用程序，应用可以运行在本地、云端和物联网设备上。
</blockquote>
...
<Button>
	<a href='https://github.com/yaoapp/crm' target='_blank'>
		源码
	</a>
</Button>
...
<Button className='mr_12' type='primary'>
	<a href='https://demo-warehouse.yaoapps.com' target='_blank'>
		演示
	</a>
</Button>

<Button>
	<a href='https://github.com/yaoapp/warehouse' target='_blank'>
		源码
	</a>
</Button>
...
<Notice type='warning'>
	注意：开始前需要了解JSON、RESTFul API、关系型数据库的基本概念和常识，并可以使用常见终端命令。
...
<Extend title='安装调试' desc='了解如何在本地建立Yao开发调试环境' link='a.介绍/b.安装调试'></Extend>
