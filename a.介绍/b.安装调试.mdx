...
| 镜像                | 环境     | 使用场景                                                   |
| ------------------- | -------- | ---------------------------------------------------------- |
| yao:0.9.1-amd64-dev | 开发环境 | `amd64` 适用于 MacOS Intel, Windows X86 64 位, Linux 64 位 |
| yao:0.9.1-arm64-dev | 开发环境 | `arm64` 适用于 MacOS M1, 树莓派, RK 开发板等               |
| yao:0.9.1-amd64     | 生产环境 | 适用于云端部署                                             |
| yao:0.9.1-arm64     | 生产环境 | 适用于物联网边缘设备部署                                   |
