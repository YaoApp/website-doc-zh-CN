...
2. 创建并启动容器: `docker run -d -v /your-project-root:/app -p 5099:5099 yaoapps/yao:0.9.11`
...
如果使用 `docker` 方式安装，忽略本步骤。**在调试模式下，保存界面描述文件，会自动更新重启服务，刷新页面接口实时预览**，打开命令行终端，**在项目根录下运行**:
...
<Video src='//player.bilibili.com/player.html?aid=507380047&bvid=BV1Sg411w7hs&cid=465617729&page=1'></Video>
...
<Div style={{ display: 'flex', justifyContent: 'space-between' }}>
	<Link type='prev' title='创建数据模型' link='/doc/c.基础特性/a.创建数据模型'></Link>
