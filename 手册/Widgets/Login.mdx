...
<Detail title="查看管理员登录示例 /data/logins/admin.json.json">
...
<Detail title="查看用户登录示例 /data/logins/user.json.json">
...
| args    | Array\<String\> | 是     |        | `[":paylod"]`     | 处理器参数表, 与 API `in` 定义相同, 接受登录 API 请求数据 |
...
| menus      | Array  | 是     | 应用菜单 [menu Object](App.mdx#menu Object)              |
...
| -------- | ------------------------------ | ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| `GET`    | `/api/__yao/login/:id/captcha` | `-`  |                                                                                                                                                                | 获取用户登录图片验证码 |
...
| 处理器                     | 参数表                               | 返回值     | 说明                                           |
| -------------------------- | ------------------------------------ | ---------- | ---------------------------------------------- |
| yao.utils.Captcha          |                                      | 图片验证码 | 返回图片验证码 [查看手册](../处理器/Utils.mdx) |
| yao.utils.CaptchaValidate  | `["<验证码ID>", "<验证码>"]`         |            | 图片验证码校验 [查看手册](../处理器/Utils.mdx) |
