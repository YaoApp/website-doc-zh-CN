...
| DSL 文件                          | Widget ID |
| --------------------------------- | --------- |
| /data/app/logins/admin.login.yao | `admin`   |
| /data/app/logins/user.login.yao  | `user`    |
...
<Detail title="查看管理员登录示例 /data/app/logins/admin.login.yao">
...
<Detail title="查看用户登录示例 /data/app/logins/user.login.yao">
