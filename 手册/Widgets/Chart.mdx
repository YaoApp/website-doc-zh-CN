...
查看 [代码示例](https://github.com/YaoApp/demo-crm/blob/master/kanban/index.kan.json)
...
| API                     | 说明                                       | 文档                                                                     |
| ----------------------- | ------------------------------------------ | ------------------------------------------------------------------------ |
| xiang.chart.XXX.Data    | 请求制定图表的数据                         | [文档](https://github.com/YaoApp/yao/blob/main/yao/apis/chart.http.json) |
| xiang.chart.XXX.Setting | 读取制定数据表格配置信息, 用于前端界面渲染 | [文档](https://github.com/YaoApp/yao/blob/main/yao/apis/chart.http.json) |
