...
| DSL 文件                                | Widget ID        |
| --------------------------------------- | ---------------- |
| /data/app/tables/user.tab.yao           | `user`           |
| /data/app/tables/user/tasks.tab.yao     | `user.tasks`     |
| /data/app/tables/user/stat/list.tab.yao | `user.stat.list` |
...
<Detail title="查看表格示例 /data/app/tables/pet.tab.yao">
