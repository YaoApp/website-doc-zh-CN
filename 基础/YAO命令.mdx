...
建立 socket 连接。 [使用 Socket Widget DSL 建立 Socket 连接](../参考手册/Widgets/Socket)
...
建立 WebSocket 连接。 [使用 Socket Widget DSL 建立 WebSocket 连接](../参考手册/Widgets/WebSocket)
...
<Div style={{ display: "flex", justifyContent: "space-between" }}>
  ...
  <Link type="next" title="应用目录结构" link="基础/应用目录结构"></Link>
</Div>
