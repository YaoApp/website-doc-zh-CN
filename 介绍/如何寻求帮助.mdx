...
| 应用          | 类型              | 仓库地址                                |
| ------------- | ----------------- | --------------------------------------- |
| Yao KNOWLEDGE | AIGC 应用         | https://github.com/YaoApp/yao-knowledge |
| PLM DEMO      | 业务系统          | https://github.com/YaoApp/demo-plm      |
| FINANCE DEMO  | 业务系统          | https://github.com/YaoApp/demo-finance  |
| PROJECT DEMO  | 业务系统          | https://github.com/YaoApp/demo-project  |
| DEV DEMO      | 最新功能展示 demo | https://github.com/YaoApp/xgen-dev-app  |
