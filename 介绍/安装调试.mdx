...
2. 创建并启动容器: `docker run -d --name yao -v <project root>:/data/app -p 5099:5099 -p 5077:5077 yaoapp/yao:0.10.3-dev-amd64-dev`
...
| yaoapp/yao:0.10.3-dev-amd64-dev | 开发环境 | `amd64` 适用于 MacOS Intel, Windows X86 64 位, Linux 64 位 |
