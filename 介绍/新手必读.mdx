...
<blockquote>
  ...
  <p>这篇文章主要介绍 Yao 的由来、Yao 的设计理念以及Yao的一些入门资料。</p>
</blockquote>

<Notice type="warning">
  <p>
    <strong>Yao (yáo)</strong> 的名字源于汉字 <strong>爻 (yáo)</strong>
    ，是构成八卦的基本符号。
  </p>
  <p>
    八卦，是上古大神伏羲观测总结自然规律后，创造的一个可以指代万事万物的符号体系。爻，有阴阳两种状态，就像
    0 和 1。爻的阴阳转换，驱动八卦更替，以此来总结记录事物的发展规律。
  </p>
</Notice>
...
2022 年 2 月，Yao 在 Github 开源, 历经 1 年多的迭代，逐渐走向成熟。
...
- Yao 将一切都封装到了引擎中，最后形态为一个命令行工具，使用体验和 NodeJS/PHP 相似。
- 数据库原子操作的处理器(方法)，与 Laravel 相似。
- Yao 的官网长得很像 Nextjs。
...
**恰逢 AIGC 时代变革，Yao DSL 的方案天然与大模型无缝对接。** 与大模型结合效果演示可查看 [使用 Yao 快速开发具备 AIGC 能力的企业应用](https://www.bilibili.com/video/BV16W4y1R78P/?vd_source=2f1a3f3ca756ac53a39a1d52bb8aee6d)

同时 Yao 也集成了 v8 引擎，复杂逻辑可以通过编写 JavaScript 脚本实现，在一些场景下，可以代替 Node/PHP 使用。

<Notice type="warning">
  <p>
    v0.10.3 之后 Yao DSL 文件的扩展名为 <strong>.yao</strong>{" "}
    可在代码编辑器中将其映射为 <strong>.jsonc</strong>{" "}
    即可高亮显示。后续将会推出官方代码高亮和补全插件。
  </p>
...
![群邀请](https://release-bj-1252011659.cos.ap-beijing.myqcloud.com/docs/v0.10.3/files/%E6%96%B0%E6%89%8B%E5%BF%85%E8%AF%BB.jpg)
...
[2023 低代码产业大会分享视频回放](https://wx.vzan.com/live/page/2029568532?shauid=J_zftpskoGA1kFgzgsOFGA**&vprid=0&sharetstamp=1685164101829)
