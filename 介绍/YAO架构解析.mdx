...
![介绍](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E4%BB%8B%E7%BB%8D/architecture.png)
...
2. 支持程序编写， 根据上下文逻辑，自动生成 DSL 或脚本代码，甚至可以接入 AI 让人工智能编程序。
3. 支持图形界面编写，使用 Studio 通过托拉拽图形化编程。

用程序编写示例: https://github.com/YaoApp/yao-admin
